...
// const sheetId = '1y_khFlIsC8YKukOCaa7Jwg37S47r1b-mgBq2vQ9q19E';
...
//         res.json({ message: 'CSV uploaded, Google Sheets updated, and email sent (if requested).' });
//     } catch (error) {
...
//                 html: { path: './chart.html' } // HTML content for the email body
//             };
